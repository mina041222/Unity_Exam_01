...
public class GameManager : MonoBehaviour
{
    ...
    public float TotalTime = 0.0f;          //전체 체크시간
    public float TimeCursur = 10.0f;        //간격 시간 설정(레벨)
    public float TimeCursorCheck = 0.0f;    //간격 시간 체크 flaot
