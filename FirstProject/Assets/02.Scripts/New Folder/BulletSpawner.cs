...
public class BulletSpawner : MonoBehaviour
{
    ...
    public float spawnRateMax = 3.0f;   //최대생성 주기 
    ...
    void Start()
    {
        ...
        timeAfterSpawn = 0.0f;  //최근 생성 이후의 누적 시간을 0초로 초기화

        spawnRate = Random.Range(spawnRateMin, spawnRateMax);  //타알 생성 간격을 랜덥 지정
    ...
    void Update()
    {
        timeAfterSpawn += Time.deltaTime;       //timeAgerSpawn 갱신
